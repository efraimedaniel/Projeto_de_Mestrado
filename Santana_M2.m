...
dado = importdata('sant_716_2005.txt');
...
grid on;
text(max(anos_unicos), min(amplitudes_M3), sprintf(' = %.3f cm/ano', taxa_anual_M3),... 
'HorizontalAlignment', 'right', 'VerticalAlignment', 'bottom', 'FontSize', 8);
...
grid on;
text(max(anos_unicos), min(fases_M3), sprintf(' = %.3f °/ano', taxa_anual_fase_M3),... 
'HorizontalAlignment', 'right', 'VerticalAlignment', 'bottom', 'FontSize', 8);
%
