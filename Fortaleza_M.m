...
% Identificar as principais componentes de maré e estimar o sinal-ruído para cada ano
%for i = 1:length(anos_unicos)
    % Obter os coeficientes harmônicos para o ano atual
 %   coeficientes_atual = coeficientes_harmonicos{i};
    
    % Identificar as principais componentes de maré usando UTide
  %  [principais_componentes{i}, sinal_ruido{i}] = ut_solv(coeficientes_atual);
%end

% Agora temos as principais componentes de maré identificadas e estimativas de sinal-ruído para cada ano.
% Podemos usar essas informações para avaliar a importância relativa das diferentes componentes de maré em cada ano.
...
title('Amplitude da Componente M2 em Fortaleza');
grid on;
...
title('Fase da Componente M2 em Fortaleza ');
grid on;
%}
